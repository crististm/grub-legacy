...
for link_addr in 2000 8000 7C00; do
  if AC_TRY_COMMAND([${CC-cc} ${CFLAGS} -nostdlib -static -Wl,-N -Wl,-Ttext -Wl,$link_addr conftest.o -o conftest.exec]); then :
  else
...
[AC_LINK_IFELSE([AC_LANG_PROGRAM([[]], [[asm ("incl start")]])],[grub_cv_check_start_symbol=yes],[grub_cv_check_start_symbol=no])])
...
[AC_LINK_IFELSE([AC_LANG_PROGRAM([[]], [[asm ("incl _start")]])],[grub_cv_check_uscore_start_symbol=yes],[grub_cv_check_uscore_start_symbol=no])])
...
[AC_LINK_IFELSE([AC_LANG_PROGRAM([[]], [[asm ("incl __bss_start")]])],[grub_cv_check_uscore_uscore_bss_start_symbol=yes],[grub_cv_check_uscore_uscore_bss_start_symbol=no])])
...
[AC_LINK_IFELSE([AC_LANG_PROGRAM([[]], [[asm ("incl edata")]])],[grub_cv_check_edata_symbol=yes],[grub_cv_check_edata_symbol=no])])
...
[AC_LINK_IFELSE([AC_LANG_PROGRAM([[]], [[asm ("incl _edata")]])],[grub_cv_check_uscore_edata_symbol=yes],[grub_cv_check_uscore_edata_symbol=no])])
...
[AC_LINK_IFELSE([AC_LANG_PROGRAM([[]], [[asm ("incl end")]])],[grub_cv_check_end_symbol=yes],[grub_cv_check_end_symbol=no])])
...
[AC_LINK_IFELSE([AC_LANG_PROGRAM([[]], [[asm ("incl _end")]])],[grub_cv_check_uscore_end_symbol=yes],[grub_cv_check_uscore_end_symbol=no])])
